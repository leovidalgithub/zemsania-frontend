    ...
    function editCalendarsController($scope, CalendarFactory, $stateParams, UserFactory, $timeout, $state) {
        ...
        function showCalendar(calendar, month) {
            jQuery(calendar).datepicker({
                ...
                onSelect: dayClicked.bind(null, calendar, month),
        ...
        function dayClicked(calendar, month, date, inst) {
                date = new Date(date).getTime();
                eventDates[date].type = 'holidays'; // every day-clicked turn to HOLIDAY!
                $timeout(function () {
                    showCalendar(calendar, month);
                }, 1230);
            }
